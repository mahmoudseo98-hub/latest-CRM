...
(function () {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .ws3d-shell{grid-template-columns:var(--ws3d-l-w,240px) minmax(340px,1fr) var(--ws3d-r-w,300px) var(--decor-w,236px)!important;transition:grid-template-columns .18s ease}
      @media (max-width:1420px){.ws3d-shell{grid-template-columns:var(--ws3d-l-w,205px) minmax(320px,1fr) var(--ws3d-r-w,268px) var(--decor-w,226px)!important}}
      @media (max-width:1220px){.ws3d-shell{grid-template-columns:var(--ws3d-l-w,180px) minmax(300px,1fr) var(--ws3d-r-w,246px) var(--decor-w,216px)!important}}
